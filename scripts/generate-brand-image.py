...
STYLE_RULES = (
    ...
    "pair dancers as man-and-woman couples in clean CONNECTED frames where the joined hands actually "
    "meet in a proper handhold and the embracing hand lands on the partner - NO tangled, floating or "
    "weirdly overlapping hands. "
